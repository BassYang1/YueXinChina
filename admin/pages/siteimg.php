...
$(function(){
	...
	BS_Upload.create({parent: ".main", title:"首页Banner", module: "company", fileKey: "company_banner", view: BS_Upload.Mode.Multi, viewBtn: BS_Upload.Button.OnlyDel, width: 960, height: 300});

	BS_Upload.create({parent: ".main", title:"内页Banner", module: "company", fileKey: "company_banner2", view: BS_Upload.Mode.Single, viewBtn: BS_Upload.Button.None, showLink: false, showDesc: false, width: 960, height: 300});
});
