<?php 
	...
	//静态化
	if(is_file("spirit.html") && !isset($_GET["sp"])){ //存在静态页面，并且不是执行静态化处理
		header("Location: spirit.html");
		exit; 
	}
...
<?php //新闻信息
	...
	$query->contentKey = "company_spirit";
        ...
        <div class="content">
            ...
            <div class="ct_r_box f_right">
                <div class="ct_right">
                    ...
                    <div class="m_title">
                        <div class="m_title_name">企业风貌</div>
