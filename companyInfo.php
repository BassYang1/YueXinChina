<?php require_once("admin/include/common.php"); ?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>岳信.中国IP防水试验机第一品牌,给您提供最专业的IP防水检测设备系统解决方案</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="keywords" content="IP防水试验机, IPX12滴雨试验机, IPX34摆管淋雨试验机, IPX56强喷水试验机, IPX78浸水试验机, UL喷水试验装置, 日标淋雨试验箱, 手持式淋雨试验装置, IPX9K高压喷淋试验箱, IPX8压力浸水试验机防尘箱, IP56防尘试验箱" />
    <meta name="description" content="IP防水试验机, IPX12滴雨试验机, IPX34摆管淋雨试验机, IPX56强喷水试验机, IPX78浸水试验机, UL喷水试验装置, 日标淋雨试验箱, 手持式淋雨试验装置, IPX9K高压喷淋试验箱, IPX8压力浸水试验机防尘箱, IP56防尘试验箱" />
...
<body>
    ...
    <div id="header_box">
        ...
        <div class="header_top">
            <div class="welcome f_left">
                您好,欢迎来到本网站！专业生产：IP防水试验机,摆管淋雨试验机和压力浸水试验机等产品.</div>
        ...
        <div class="nav_box">
            <ul class="nav">
                <li class="n_menu f_right">
                    <h3>
                        <a title="联系我们" href="#barcode">联系我们</a>
                    </h3>
                </li>
                <li class="sep f_right hidden">|</li>
                <li class="n_menu f_right">
                    <h3>
                        <a title="资料下载" style="width: 80px;" href="#">资料下载</a>
                    </h3>
                </li>
                <li class="sep f_right hidden">|</li>
                <li class="n_menu f_right">
                    <h3>
                        <a title="成功案例" style="width: 80px;" href="cases/casesAll.html">
                            成功案例</a>
                    </h3>
                </li>
                <li class="sep f_right hidden">|</li>
                <li class="n_menu f_right">
                    <h3>
                        <a title="公司新闻" style="width: 80px;" href="news/newsAll.html">
                            公司新闻</a>
                    </h3>
                </li>
                <li class="sep f_right hidden">|</li>
                ...
                <li class="n_menu f_right">
                    <h3>
                        <a title="走进岳信" style="width: 80px;" href="companyInfo.html">
                            走进岳信</a>
                    </h3>
                </li>
                <li class="sep f_right hidden">|</li>
                <li class="n_menu f_right">
                    <h3>
                        <a title="首页" style="width: 60px;" href="index.html">
                            首页</a>
                    </h3>
                </li>
        ...
        <div id="banner">
            <a href="index.html" target="_blank">
                <img class="banner_img" src="images/banner.jpg"
                    alt=""></a> <a href="index.html" target="_blank">
                        <img class="banner_img" src="images/banner.jpg"
                            alt=""></a> <a href="index.html" target="_blank">
                                <img class="banner_img" src="images/banner.jpg"
                                    alt=""></a> <a href="index.html" target="_blank">
    ...
    <div id="local_box">
        <div class="local">
            ...
            <div class="hot_search f_right">
                热门机型：<a href="#">摇摆淋雨试验机</a><a href="#">摇摆淋雨试验机</a><a href="#">强喷水试验机</a></div>
            <div class="clear">
            </div>
        </div>
    </div>
        ...
        <div class="content">
            <div class="ct_left f_left">
                <div class="ct_l_section">
                    ...
                    <div class="l_menu">
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item3"><a href="companyInfo.html"
                                target="_blank">公司简介 &nbsp;>></a></span> </dt>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item3"><a href="companyHistory.html"
                                target="_blank">发展历程 &nbsp;>></a></span> </dt>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item3"><a href="companyStyle.html"
                                target="_blank">企业风貌 &nbsp;>></a></span> </dt>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item3"><a href="companyCert.html"
                                target="_blank">资质证书 &nbsp;>></a></span> </dt>
                        </dl>
                    </div>
                </div>
                <div class="ct_l_section mt5">
                    ...
                    <div class="l_menu">
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail1.html"
                                target="_blank">YX-ZC400S综合</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail10.html"
                                target="_blank">IPX800A500-</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail9.html"
                                target="_blank">IPX800B500-</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail8.html"
                                target="_blank">IPX800C500-</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail7.html"
                                target="_blank">IPX800D 500</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail6.html"
                                target="_blank">IPX800E600-</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail5.html"
                                target="_blank">IPX800F600-</a></span> </dt>
                        </dl>
                        <dl>
                            <dt style="cursor: hand; float: left;"><span class="l_m_item"><a href="product/productDetail4.html"
                                target="_blank">无流量计花洒淋雨试验装</a></span> </dt>
                        </dl>
                    </div>
                </div>
                <!--contact-->
            ...
            <div class="ct_r_box f_right">
                <div class="ct_right">
                    ...
                    <div class="ct_r_panel">
                        <?php echo str_replace("../", "", Content::get("company_introduce")); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bottom_box">
        <div class="bottom">
            <div id="barcode" class="f_left barcode">
                <img src="images/barcode.png" title="岳信.中国IP防水试验机第一品牌,给您提供最专业的IP防水检测设备系统解决方案"
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>
                            旺旺：岳信试验设备</p>
                        <p>
                            邮箱：yuexin@yuexin80.com</p>
                        <p>
                            官网：www.yuexinchina.com</p>
                        <p>
                            旺铺：http://pyyuexin.1688.com</p>
                        <p>
                            营销型网站：www.yuexin80.com</p>
                        <p>
                            地址：广州省广州市番禺区新造镇南约商业街34号</p>
                    </li>
                </ul>
            </div>
            <div class="f_left links">
                <ul>
                    ...
                    <li>
                        <p>
                            <a href="http://www.yuexinchina.com/" title="趣麦网">
                                <img src="images/links/7mai.gif" width="88"
                                    height="31" alt="趣麦网" /></a>
                        </p>
                        <p>
                            <a href="http://www.yuexinchina.com/" title="精品生活">
                                <img src="images/links/styleweekly.gif"
                                    width="88" height="31" alt="精品生活" /></a>
                        </p>
                        <p>
                            <a href="http://www.yuexinchina.com/" title="游九网">
                                <img src="images/links/uuu9.gif" width="88"
                                    height="31" alt="游九网" /></a>
                        </p>
                    </li>
                </ul>
