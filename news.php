<?php 
	...
	if(empty($newss)){
		...
		foreach($newss as $news){
			$newsHtml .= sprintf("<dl><dd><a href=\"cdetail.php?id=%u\">%s</a></dd><dt class=\"a_text\"></dt></dl>", $news->contentId, $news->subject);
		}
	}
